...
1. **Opens with "If you only read one line:"** — the single action that matters most.
...
4. **Directive voice.** No "you might consider." Either do it or do not.
...
8. **No bunker aesthetic, no doomer LARP.** Serious, competent, boring. Good emergency guidance reads like a checklist, not a movie.
...
- **Nuclear / fallout**: `survival-guides/Nuclear_War_Survival_Skills.pdf` (NWSS — Cresson Kearny, the authoritative civilian source)
...
2. [`frameworks/stay-or-go.md`](frameworks/stay-or-go.md) — the one decision that matters most
