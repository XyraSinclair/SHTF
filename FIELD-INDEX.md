...
- survival-guides/FM21-10_Field_Hygiene_Sanitation.pdf
- survival-guides/sanitation/Emergency_Toilet_Guidebook.pdf
- survival-guides/sanitation/Compendium_Sanitation_Technologies_Emergencies.pdf
...
- tools-scripts/build-llama-cpp-gemma4.sh
- tools-scripts/convert-gemma4-to-gguf.sh
- tools-scripts/quantize-gemma4-gguf.sh
